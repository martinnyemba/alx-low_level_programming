...
## Description
This project focuses on implementing different search algorithms in C:

- Linear search
- Binary search
The goal is to understand how each algorithm works and the time complexity of each.
...
2-O - File containing big O notations

## Tests :

* [tests](./tests): This is the Folder of test files for all tasks. Provided by ALX.
